...
def run_full_historical_agent(
    ...
    """Run the complete V6.5 analysis pipeline at T with the user's own profile."""
...
def run_historical_replay(
    ...
    """Replay V6.5 at T and return no post-T performance data."""
    ...
    snapshot = {
        "tool_version": "完整界面独立历史时点测试工具V2.1",
